...
$ServerName = "LOCALHOST"                       # Change as needed, this is the server name to check for the Qualys CSV file.
...
$BackupBitlocker = $false                    # This will backup Bitlocker Keys to AD
