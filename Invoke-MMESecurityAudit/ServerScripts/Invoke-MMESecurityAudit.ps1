...
#
#  Alex Datsko (alexd@mmeconsulting.com) Started 2021-06-03
#
# 0.11 - 03-30-22 - Draft 2
#
...
# Check manually for now, too many variables, unless we were to pull from Acronis cyber maybe
explorer.exe = 
...
# Disabled, this seems to save way too much and make things hard to search thru by hand, unfortunately.  Would be nice to have the info, but right now it might be too much, needs discussion and testing etc.
