#####################################
#
# Get-DellServerUpdates.ps1 - v0.91
#
...
if (Test-Path($DSUExe)) {
    ...
    Write-EventLog -LogName "MME" -Source "Dell Server Updates" -EventId 10501  -EntryType Information -Message "Dell DSU utility - update check began.."
    ...
    if ($UpdatesAvailable -ne "") {           # Make sure we have any updates at all..
