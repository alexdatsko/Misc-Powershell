...
# describes the function GetShadowCopyStats
Describe 'GetShadowCopyStats' {
  ...
  Context 'Running without arguments'   {
    ...
    It 'runs without errors' {
      ...
      # scriptblock (braces):
      { GetShadowCopyStats } | Should Not Throw
    }
    It 'does something' {
      # call function GetShadowCopyStats and pipe the result to an assertion
      # Example:
      # GetShadowCopyStats | Should Be 'Expected Output'
      # Hint: 
    ...
    It 'does not return anything'     {
      GetShadowCopyStats | Should BeNullOrEmpty 
    }
  }
}
