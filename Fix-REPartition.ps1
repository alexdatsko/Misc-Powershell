# Fix-REPartition.ps1
# KB5034441 (and further superceded patches) - Official MS fix for RE partition sizing
# https://techcommunity.microsoft.com/t5/windows-10/kb5034441-fails-to-install-with-error-code-0x80070643/m-p/4028519
...
[Parameter(Mandatory=$false,HelpMessage="Path to backup old WinRE partition content to")][string]$BackupFolder="C:\REimage_temp"
)
# ------------------------------------
# Helper functions
# ------------------------------------
